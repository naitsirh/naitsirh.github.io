// usamos XHR para recuperar los productos y pasarlos a init
...
function initialize(products) {
  ...
  // fetchBlob usa XHR para recuperar la imagen de ese producto,y luego
  ...
  function fetchBlob(product) {
    ...
    // usamos XHR para recuperar la imagen, como un blob. Nuevamente, si ocurre
    // algún error, lo informamos en la consola
    const request = new XMLHttpRequest();
